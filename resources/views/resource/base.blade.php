					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li>
									<a href="{{url('resource/index/index')}}">首页</a>
								</li>
								<!-- <li>
									<a href="{{url('resource/pdf/index')}}">PDF书库</a>
								</li> -->
								<li>
									<a href="{{url('resource/document/index')}}">文档</a>
								</li>
								<li>
									<a href="{{url('resource/link/index')}}">链接</a>
								</li>
							</ul>
							<ul class="nav navbar-nav navbar-right">
								<li>
									<a href="{{url('index/index/index')}}">主站</a>
								</li>
								<li>
