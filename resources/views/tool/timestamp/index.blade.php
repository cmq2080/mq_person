...
<style type="text/css">
    ...
    #time2 .form-group input{width:8rem;}
</style>
@endsection
...
<script type="text/javascript">
    ...
    function timeToTimestamp() {
        var year=$("#year").val(),month=$("#month").val(),day=$("#day").val(),hour=$("#hour").val(),minute=$("#minute").val(),second=$("#second").val();
