...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/static/css/index/init.css" />
		<link rel="stylesheet" type="text/css" href="/static/css/index/common.css" />
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="{{url('index/project')}}">项目作品</a>
								</li>
								<li>
							...
							<ul class="nav navbar-nav navbar-right">
								<li>
									<a href="{{url('resource/index/')}}">资源</a>
								</li>
								<li>
									<a href="{{url('tool/index/')}}">工具</a>
								</li>
							</ul>
						</div>
						<!-- /.navbar-collapse -->
